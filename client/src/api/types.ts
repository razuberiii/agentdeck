...
export type Session = { id:string; codex_thread_id:string; provider_id?:ProviderId; providerId?:ProviderId; project_dir:string; title:string; status:string; activeTurn?:ActiveTurn|null; permission_mode?:string; approval_policy?:string; sandbox_mode?:string; model?:string; modelRevision?:number; archived?:number; created_at?:number; updated_at?:number; last_sequence?:number };
